<?php $course = 'CERTIFICATION IN 3D MAYA'; ?>
        ...
        <div class="section-content">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
              ...
              <h3 class="title text-black text-center">CERTIFICATION IN 3D MAYA</h3>
            ...
            <div class="col-md-12 col-sm-12 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              ...
              <p>In this course, you will learn how to start working in Maya by getting around the interface a bit and learning how to navigate the UI. Then, you began working by creating a new project, creating basic objects such as primitives, and placing objects in the scene. You learned how to place pivot points for objects and how to use snaps to place points precisely. Now, you had some experience with the interface and Attribute Editor to start working on 3D modelling, then will explore how to create simple shaders for your objects and set keyframes to animate inorganic objects. The other important aspects like object hierarchy and grouping conventions to organize and set up your scene better, and finally you learned how to output a basic play blast video file of your completed animation.</p>
            ...
            <div class="pt-60 pb-40 pl-90 pr-160 p-md-30">
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> Introduction to 3D </h4>
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> Digital Assets Concepts</h4>
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> 3D Object Modeling</h4>
               ...
               <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> Character Modeling</h4>
            ...
            <div class="pt-60 pb-40 pl-90 pr-160 p-md-30">
              ...
              <div class="icon-box clearfix mt-80 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> 3D Shading & Texturing</h4>
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> Rigging & Animation Basics</h4>
             ...
             <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> Introduction to Lighting</h4>
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> Portfolio</h4>
          ...
          <div class="row">
            ...
            <div id="accordion1" class="panel-group accordion transparent">
              ...
              <div class="panel">
                ...
                <div class="panel-title"> <a data-parent="#accordion1" data-toggle="collapse" href="#accordion11" class="active" aria-expanded="true"> <span class="open-sub"></span> <strong>COMPOSITING
                ...
                <div id="accordion11" class="panel-collapse collapse in" role="tablist" aria-expanded="true">
                  ...
                  <p>Introduction Maya.<br>

                   Digital concepts.<br>

                   2D & 3D fundamentals.<br>

                   Lighting and rendering.<br>

                   Tracking & match Moving.<br>
