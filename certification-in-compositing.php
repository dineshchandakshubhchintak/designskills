<?php $course = 'CERTIFICATION IN COMPOSITING '; ?>
        ...
        <div class="section-content">
          ...
          <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
              ...
              <h3 class="title text-black text-center">CERTIFICATION IN COMPOSITING </h3>
            ...
            <div class="col-md-12 col-sm-12 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              ...
              <p>Our compositing course give you the skills from the basics of visualization design, composition, scaling & proportion, color theory, set extension, VFX filmmaking process and chroma shoot. Exposure to 3D CGI Elements. Our in-house facilities have VFX shooting floor green room to experience the real production process and techniques. We teach seamless integration of CG elements with real characters and the complete process of photorealistic lighting and compositing.  This program is also very well designed to enable a student to excel to become expert in compositing. Those who are working as a ROTO / Paint artist, if they want to upgrade to compositing this course is ideal for them.
            ...
            <div class="pt-60 pb-40 pl-90 pr-160 p-md-30">
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> CGI Lighting</h4>
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> 3D VFX</h4>
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1">Compositing 1 - After Effects</h4>
            ...
            <div class="pt-60 pb-40 pl-90 pr-160 p-md-30">
              ...
              <div class="icon-box clearfix mt-80 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> Compositing 2 - Nuke</h4>
              ...
              <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1">Tracking & Match Moving</h4>
             ...
             <div class="icon-box clearfix m-0 p-0 pb-10">
                ...
                <div class="ml-120 ml-sm-0">
                  ...
                  <h4 class="icon-box-title text-white mt-20 mb-11 letter-space-1"> Graduation Project</h4>
              ...
              <div class="panel">
                ...
                <div id="accordion11" class="panel-collapse collapse in" role="tablist" aria-expanded="true">
                  ...
                  <div class="panel-content">
                   ...
                   <p> Introduction Compositing.<br>

                    Chroma keying.<br>

                    Color correction.<br>

                    Introduction to roto & Paint. <br>

                    3D multilayer compositing.<br>
