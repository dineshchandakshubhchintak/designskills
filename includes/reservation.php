...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['reservation_email'] != '' AND $_POST['reservation_phone'] != '' AND $_POST['car_select'] != '') {
        ...
        $reservation_city = isset($_POST['reservation_city']) ? $_POST['reservation_city'] : '';
        ...
        if( $botcheck == '' ) {
            ...
            $reservation_city = isset($reservation_city) ? "Reservation Date: $reservation_city<br><br>" : '';

            $referrer = $_SERVER['HTTP_REFERER'] ? '<br><br><br>This Form was submitted from: ' . $_SERVER['HTTP_REFERER'] : '';

            $body = "$name $email $phone $car $reservation_city $referrer";
